...
class Encoder(nn.Module):
    def __init__(self, in_channels=4, embed_dim=384, embedding_dim=27, channels=(48, 96, 240),
                 blocks=(1, 2, 3, 2), heads=(1, 2, 4, 8), r=(4, 2, 2, 1), num_slices_list = [64, 32, 16, 8], distillation=False, dropout=0.3):
...
class GobleAttention(nn.Module):
    def __init__(self, in_dim=1, out_dim=32, num_slices=8, shallow=True):
